...
You give it your resume. It analyses live AI job listing and tells you:
...
```bash
ollama pull llama3.2:3b       # 4.7 GB, works on 8 GB RAM
...
\* Built a RAG pipeline with ChromaDB to index 10+ Live job descriptions and perform semantic skill-gap analysis against candidate resume
